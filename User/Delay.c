//-----------------------------------------------------------------
// 程序描述:
//     手工计算不同时基的延时程序:ns,10us,250us,1ms,5ms,50ms
// 作    者: 凌智电子
// 开始日期: 2014-01-28
// 完成日期: 2014-01-29
// 修改日期: 2014-02-15
...
void Delay_10us (u16 t)
{
	...
	do {
		j = 7;						// j=6,i=13,737,1.0236us误差236ns
		do {							// j=7,i=11,731,1.0152us,误差152ns
			i = 11; 
			do {									 
       } while (--i);	
		} while (--j);		
...
// 时钟嘀嗒：			
//		1.定时1ms = T*Tick77;	
// 		2.系统时钟72MHz,即一个系统时钟T=1/72MHz(s);
//		3.重装载值Reload= 节拍数-1;
// 		4.SysTick_Config函数中输入节拍数Tick =72MHz/1000=72000，
//		-->时基100ms:Tick = 72*10^6*0.1=7200000
//		-->时基50ms: Tick = 72*10^6**0.05= 3600000
//		-->时基1us:  Tick = T*Reload-->Reload = 72*10^6*1*10^(-6)=72
//		-->时基10us: Tick = 720
//		-->时基250us:Tick = 72*10^6*250*10^(-6)=18000
手工延时：
